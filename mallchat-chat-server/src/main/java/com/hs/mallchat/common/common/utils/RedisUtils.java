...
public class RedisUtils {
    ...
    /**
     * 静态代码块，用于初始化RedisUtils类中的stringRedisTemplate字段。
     * 通过SpringUtil的getBean方法，获取StringRedisTemplate类型的Bean并赋值给stringRedisTemplate。
     * 这样做可以在类的其他静态方法中直接使用stringRedisTemplate，而不需要实例化RedisUtils类。
     *
