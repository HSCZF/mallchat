package com.hs.mallchat.transaction;
...
public class MPGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/mallchat-tools/mallchat-transaction/src/main/java");
        //设置作者名字
        ...
        packageConfig.setParent("com.hs.mallchat.transaction");//自定义包的路径
